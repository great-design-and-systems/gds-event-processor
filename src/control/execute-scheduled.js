    ...
    constructor(services, job, callback) {
        ...
        getJobById.execute({
            ...
            if (errScheduledJob) {
                ...
                global.gdsLogger.logInfo('cur date =>'+ new Date());
                global.gdsLogger.logInfo('scheduled date =>' + new Date(scheduled.dateTime));
                Schedule.scheduleJob(new Date(scheduled.dateTime), () => {
